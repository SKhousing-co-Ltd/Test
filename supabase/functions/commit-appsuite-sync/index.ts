...
Deno.serve(async (request) => {
  ...
  try {
    ...
    // Contract work requests are enqueued by the appsuite_record database
    // trigger. Keeping the classification in appsuite_application makes newly
    // configured forms work for both manual and scheduled syncs.
